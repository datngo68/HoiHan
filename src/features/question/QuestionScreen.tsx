...
export default function QuestionScreen() {
  ...
  const { session, config, setScreen, recordRefusal, resetJourney, generateJourneySteps } = useAppStore()
  ...
  }, [setScreen, resetJourney, generateJourneySteps, config.enableHeartJourney])
