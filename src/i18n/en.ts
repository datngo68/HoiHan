const en = {
  ...
  question: {
    ...
    noTooltips: [
      ...
      'Bet {{receiver}} can never catch this!',
      'No way out!',
  ...
  heartJourney: {
    title: 'Heart Journey',
    subtitle: 'Complete {{total}} challenges to unlock a special moment!',
    stepBadge: 'Step {{step}}/{{total}}',
    skip: 'Skip Journey',
    step1Title: 'Prove your heart is beating!',
    step1Desc: 'Tap the heart {{target}} times in {{seconds}}s',
    step2Title: 'Sweet Love Question',
    step2Desc: 'Pick the right answer!',
    step3Title: 'Secret Promise',
    step3Desc: 'Type this phrase to confirm your love',
    unlockStep1: 'Heart has been confirmed!',
    unlockStep2: 'Perfect answer!',
    unlockStep3: 'Promise has been recorded!',
    allUnlocked: 'Love has been proven!',
    continueBtn: 'Continue',
    rewardTitle: 'Love Has Been Proven!',
    rewardSubtitle: '{{receiver}} truly loves {{sender}}!',
    rewardBadge: 'Heart Journey Complete',
  },
} as const
